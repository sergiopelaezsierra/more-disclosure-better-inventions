...
|---|---|---|---|
| Replication code (this package) | GitHub: <https://github.com/sergiopelaezsierra/more-disclosure-better-inventions> · Zenodo concept DOI: [10.5281/zenodo.20186754](https://doi.org/10.5281/zenodo.20186754) (v1.0.0 = [10.5281/zenodo.20186755](https://doi.org/10.5281/zenodo.20186755)) | <2 MB | MIT |
| Three temporal SciBERT classifiers (`model_2019_2020`, `model_2021_2022`, `model_2023_2025`) | Zenodo concept DOI: [10.5281/zenodo.20184929](https://doi.org/10.5281/zenodo.20184929) (v1.0.0 = [10.5281/zenodo.20184930](https://doi.org/10.5281/zenodo.20184930)). Also mirrored locally for development at `trained_models/` or `../Trained models/`. | ~1.3 GB total | Apache 2.0 (derived from `allenai/scibert_scivocab_uncased`) |
